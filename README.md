...
* [Requestly](https://requestly.com/student-program) [FREE] – Requestly is a versatile API client, HTTP interceptor, and request modification tool available on both web and desktop platforms. Through the Requestly Student Program, students get full access to all its powerful tools completely free.
